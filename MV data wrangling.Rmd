...
MV_WEIRD <- merge(MV_WEIRD, MV_code,by=c("PID"))
 ...
 #select variables
MV_final = MV_WEIRD %>% dplyr::select(Smart, Behave, Grades, Age, Gender, Country, Video_Gender, parent, Education, PID, SES, Edu_asp, income_annual, occupation, Smart_reason, Behave_reason, Grades_reason) %>%  
